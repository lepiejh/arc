...
public final class DefaultErrorActivity extends BaseActivity<AbBinding, BaseViewModel> {
    ...
    public void initData() {
        ...
        Button restartButton = (Button) findViewById(R.id.tv_update_content);
        ...
        Button moreInfoButton = (Button) findViewById(R.id.btn_update_cancel);
        ...
        ImageView errorImageView = ((ImageView) findViewById(R.id.tv_update_title));
